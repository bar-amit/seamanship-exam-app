export const uiText = {
  ...
  admin: {
    ...
    assetMetadataTitle: "נכסי שאלה",
    imageRefsLabel: "קובצי תמונה לשאלה (image_refs, שורה לכל קובץ)",
    imageRefsPlaceholder: "לדוגמה:\nsq11-images/image_36.jpg\nsq3-inline-images/map-01.jpg",
    referencesDiagramLabel: "השאלה מתייחסת לדיאגרמת מיקום sq11",
    ...
    subAnswerTextLabel: "תשובת מודל לסעיף",
